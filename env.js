...
const BUNDLE_ID = "com.bazdevelopment.fit-log-mobile"; // ios bundle id
const PACKAGE = "com.bazdevelopment.fitlogmobile"; // android package name
const NAME = "Fit Log";
const EXPO_ACCOUNT_OWNER = "bazdevelopment";
const EAS_PROJECT_ID = ""; //EAS project id
const SCHEME = "fit-log-mobile-app";
...
const mergedEnvScheme = buildTime.merge(client);
const parsed = mergedEnvScheme.safeParse(_env);
